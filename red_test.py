...
class red_neuronal:
    ...
    @staticmethod    
    def drelu(weigthed_activation):
        return (weigthed_activation > 0 ) * 1
    ...
    def forward_prop(self):
        ...
        self.hidden_output = red_neuronal.relu(self.hidden_input)
    ...
    def back_prop(self):
        ...
        gradients_hidden = self.lr * self.error_hidden * red_neuronal.drelu( self.hidden_output )
    ...
    def predict(self, inputs):
        ...
        hidden_output = red_neuronal.relu(hidden_input)
